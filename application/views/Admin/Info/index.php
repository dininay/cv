      ...
      <section class ="content">
          <div class="container-fluid">
            ...
            <div class="card-header">
              <h3 style="display:inline-block" class="card-title"> Data Info </h3>
              <button style="float:right" type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModalCenter"> Tambah Info 
              </button>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
