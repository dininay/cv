        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <div class="card-header">
                    ...
                    <h3 class="card-title" style="display:inline-block">Data Pendidikan</h3>
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              <!-- <label>No</label> -->
              <input type="hidden" name="id" class="form-control" placeholder="No . ." value="">
            </div>
          </div>
      </div>
      <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input type="text" name="nama_pen" class="form-control" placeholder="Nama Pendidikan . ." value="">
            </div>
          </div>
      </div>
      <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              <label>Waktu</label>
              <input type="text" name="waktu_pen" class="form-control" placeholder="Waktu Pendidikan . ." value="">
            </div>
          </div>
      </div>
      <div class="row">
